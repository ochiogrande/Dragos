...
public class BattleStarter : MonoBehaviour
{
    ...
    void Start()
    {
        betweenBattleCounter = Random.Range(timeBetweenBattles * 0.5f, timeBetweenBattles * 1.8f);
    ...
    public IEnumerator StartBattleCo()
    {
        ...
        BattleManager.instance.BattleStarts(potentialBattles[selectedBattle].enemies , cannotFlee);
