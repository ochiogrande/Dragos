...
public class ItemButton : MonoBehaviour
{
    ...
    public void Press()
    {
       ...
       /* if(BattleManager.instance.itemMenu.activeInHierarchy)
        {
            if(ItemMenuSelect.instance.itemButtons[buttonValue] != "")
            {
                ItemMenuSelect.instance.ShowButtons(GameManager.instance.GetItemDetails(GameManager.instance.itemsHeld[buttonValue]));
            }
        }
        */
